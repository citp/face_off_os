...
- facetec_start_screen.png: initial prompt at beginning of Facetec age and liveness prediction task
- facetec_try_again.png: null response screen resulting from failed Facetec liveness prediction task
...
- redacted_analysis_plan.pdf: description of study protocol, risks, and post-collection analysis
- resources_for_parents.pdf: list of alternatives to biometric age assurance for parents/guardians
- study_conditions.pdf: list of potential study conditions for each study session
- study_script_os.pdf: script read aloud to participants at the start of each study session
